  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M13.61 2.954a8.433 8.433 0 011.705 2.658 8.565 8.565 0 01.62 3.248v.846l-.004.448v9.727c.005.9-.691 1.63-1.549 1.63H1.611c-.858 0-1.554-.73-1.554-1.63V8.86c0-1.13.211-2.223.626-3.25a8.4 8.4 0 011.704-2.657 7.886 7.886 0 012.522-1.8 7.53 7.53 0 016.18-.002 7.903 7.903 0 012.522 1.802zm-8.073-.326h-.005c-.736.33-1.4.811-1.983 1.425a6.809 6.809 0 00-1.38 2.154 7.074 7.074 0 00-.511 2.65v.697h12.68V8.86c0-.923-.172-1.814-.511-2.653a6.84 6.84 0 00-1.38-2.156 6.457 6.457 0 00-2.016-1.44 5.972 5.972 0 00-2.433-.52c-.846 0-1.664.176-2.43.525l-.031.012zm8.808 8.522v8.728a.11.11 0 01-.005.033H1.663a.108.108 0 01-.005-.033V11.15h12.686zm-7.086 5.698V14.75a1.39 1.39 0 01-.635-1.158 1.376 1.376 0 012.752 0c0 .474-.237.9-.63 1.153v2.103a.743.743 0 01-1.487 0z"
        fill="#000"
        fillOpacity={0.45}
      />
    </svg>
