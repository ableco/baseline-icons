...
export function CompanyObjective(props: BaseProps): JSX.Element {
  const className = cx(props.className, 'fill-current');
  ...
  return (
    ...
    >
      <path
        d="M7 13.667A6.667 6.667 0 117 .333a6.667 6.667 0 010 13.334zM5.473 12.11a11.934 11.934 0 01-1.122-4.444H1.708a5.339 5.339 0 003.765 4.444zm.214-4.444A10.61 10.61 0 007 12.167a10.603 10.603 0 001.313-4.5H5.687zm6.605 0H9.649a11.934 11.934 0 01-1.122 4.444 5.338 5.338 0 003.765-4.444zM1.708 6.333h2.643c.084-1.54.465-3.05 1.122-4.444a5.339 5.339 0 00-3.765 4.444zm3.98 0h2.625A10.603 10.603 0 007 1.832a10.603 10.603 0 00-1.313 4.501zM8.526 1.89a11.933 11.933 0 011.122 4.444h2.643A5.339 5.339 0 008.527 1.89z"
        fill="currentColor"
        fillOpacity={0.45}
      />
    </svg>
