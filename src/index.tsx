  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M17.61 3.954a8.433 8.433 0 011.705 2.658 8.565 8.565 0 01.62 3.248v.846l-.004.448v9.727c.005.9-.691 1.63-1.549 1.63H5.611c-.858 0-1.554-.73-1.554-1.63V9.86c0-1.13.211-2.223.626-3.25a8.4 8.4 0 011.704-2.657 7.886 7.886 0 012.522-1.8 7.53 7.53 0 016.18-.002 7.903 7.903 0 012.522 1.802zm-8.073-.326h-.005c-.736.33-1.4.811-1.983 1.425a6.809 6.809 0 00-1.38 2.154 7.074 7.074 0 00-.511 2.65v.697h12.68V9.86c0-.923-.172-1.814-.511-2.653a6.84 6.84 0 00-1.38-2.156 6.457 6.457 0 00-2.016-1.44 5.971 5.971 0 00-2.433-.52c-.846 0-1.664.176-2.43.525l-.031.012zm8.807 8.522v8.728a.11.11 0 01-.004.033H5.663a.108.108 0 01-.005-.033V12.15h12.686zm-7.085 5.698V15.75a1.39 1.39 0 01-.635-1.158 1.376 1.376 0 012.752 0c0 .474-.237.9-.63 1.153v2.103a.743.743 0 01-1.487 0z"
        fill="currentColor"
      />
    </svg>
  );
...
export function Markdown(props: BaseProps): JSX.Element {
  ...
  return (
    ...
    >
      <path
        d="M5.301 17l1.024-2.883h4.117L11.466 17h1.292L9.02 6.818H7.747L4.008 17h1.293zm1.412-3.977l1.63-4.594h.08l1.63 4.594h-3.34zm9.72 4.156c1.332 0 2.028-.716 2.266-1.213h.06V17h1.173v-5.031c0-2.426-1.85-2.705-2.823-2.705-1.154 0-2.466.398-3.063 1.79l1.114.398c.258-.557.87-1.154 1.988-1.154 1.08 0 1.611.572 1.611 1.551v.04c0 .567-.577.517-1.969.696-1.417.184-2.963.497-2.963 2.247 0 1.492 1.154 2.347 2.605 2.347zm.178-1.054c-.934 0-1.61-.418-1.61-1.233 0-.895.815-1.173 1.73-1.293.497-.06 1.83-.198 2.028-.437v1.074c0 .954-.756 1.889-2.148 1.889z"
        fill="currentColor"
      />
    </svg>
  );
