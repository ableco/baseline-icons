  ...
  return (
   ...
   >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M15.019 17.067a7.8 7.8 0 00-1.676-2.484 7.8 7.8 0 00-3.455-2.014 6.434 6.434 0 002.492-1.551 6.415 6.415 0 001.891-4.563c0-1.723-.67-3.345-1.891-4.564A6.415 6.415 0 007.816 0C6.094 0 4.472.67 3.253 1.891a6.415 6.415 0 00-1.891 4.564c0 1.722.67 3.344 1.891 4.563a6.434 6.434 0 002.492 1.551 7.8 7.8 0 00-3.455 2.013A7.8 7.8 0 000 20.113a.843.843 0 101.688 0c0-1.639.637-3.178 1.795-4.336a6.091 6.091 0 014.336-1.796c1.638 0 3.178.638 4.336 1.796a6.091 6.091 0 011.795 4.336.843.843 0 101.688 0 7.863 7.863 0 00-.62-3.045zM3.047 6.455c0-2.63 2.14-4.768 4.767-4.768a4.773 4.773 0 014.767 4.768 4.771 4.771 0 01-4.767 4.767 4.773 4.773 0 01-4.767-4.767zM19.5 14.85a.85.85 0 01-.85-.85v-2.8h-2.8a.85.85 0 010-1.7h2.8V6.7a.85.85 0 011.7 0v2.8h2.8a.85.85 0 010 1.7h-2.8V14c0 .47-.38.85-.85.85z"
        fill="currentColor"
      />
    </svg>
  );
